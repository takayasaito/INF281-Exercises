...
\section*{INF281 Exercise 04}

%---------------------------------------------------------------------
\begin{questions}

%%% Question 1
\input{04/DP_local_alignment.tex}
\newpage

%%% Question 2
\input{04/Dot_matrix.tex}

%%% Question 3
\input{05/N-gram.tex}

%%% Question 4
\input{05/Matching_n-gram.tex}

%%% Question 5
\input{05/Lookup_table_n-gram.tex}
\newpage

%%% Question 6
\input{05/FSM_2-gram.tex}
\newpage

%%% Question 7
\input{05/FSM_3-gram.tex}
